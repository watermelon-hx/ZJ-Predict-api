...
INSERT INTO sys_user(id, username, password, real_name, gender, email, mobile, dept_id, super_admin, super_tenant, status, tenant_code, creator, create_date, updater, update_date) VALUES (1353943117220315138, 'test', '$2a$10$012Kx2ba5jzqr9gLlG4MX.bnQJTD9UWqF57XDo2N3.fPtLne02u/m', '测试用户', 0, 'test@renren.io', '13012345678', 1067246875800000066, 0, 0, 1, 1001, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
...
INSERT INTO sys_menu(id, pid, url, permissions, type, open_style, icon, sort, creator, create_date, updater, update_date) VALUES (1113375699198033921, 0, '', '', 0, 0, 'icon-home', 2, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
INSERT INTO sys_menu(id, pid, url, permissions, type, open_style, icon, sort, creator, create_date, updater, update_date) VALUES (1113378406403162113, 1113375699198033921, 'tenant/tenant', 'sys:tenant:page,sys:tenant:info,sys:tenant:password,sys:tenant:save,sys:tenant:update,sys:tenant:delete', 0, 0, 'icon-team', 0, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
INSERT INTO sys_menu(id, pid, url, permissions, type, open_style, icon, sort, creator, create_date, updater, update_date) VALUES (1114779542196600833, 1113375699198033921, 'tenant/tenant-role', 'tenant:role:page,tenant:role:list,tenant:role:info,tenant:role:save,tenant:role:update', 0, 0, 'icon-team', 1, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
...
INSERT INTO sys_post(id, post_code, post_name, sort, status, tenant_code, creator, create_date, updater, update_date) VALUES (1341597192832811009, 'tech', '技术岗', 0, 1, 1001, 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
